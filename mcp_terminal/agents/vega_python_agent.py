...
agent = Agent(
    model=OpenAIChat(id="gpt-4o-mini", api_key=os.getenv("OPENAI_API_KEY")), system_message=systemPrompt, reasoning=True
)

agent.print_response(
    f"""Visualize the 2 players on a single horizontal groups bar chart.       
