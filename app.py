import json
from tools.definitions.knowledge_base_tool import knowledge_base_tool_definition
...
def simple_tools():
    ...
    messages = [{"role": "user", "content": "What is green + blue? and tell the sailing conditions in Seine River, Paris?"}]
